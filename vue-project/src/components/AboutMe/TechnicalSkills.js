        ...
        tools: [
            {
                ...
                text: 'React',
                des: `React makes it painless to create interactive UIs. Design simple views for each state in your application, and React will efficiently update and render just the right components when your data changes. <a href="https://reactjs.org/" target="_blank" alt="Go To VueJS">Go To ReactJS</a>`,
            },
            {
                icon: `<i class='bx bxl-vuejs' ></i>`,
                text: 'Next JS',
                des: `Nextjs makes it painless to create interactive UIs. Design simple views for each state in your application, and React will efficiently update and render just the right components when your data changes. <a href="https://reactjs.org/" target="_blank" alt="Go To VueJS">Go To ReactJS</a>`,
            },
            {
                icon: `<i class='bx bxl-vuejs' ></i>`,
                text: 'Vue',
